...
public class Joueur extends Combattant{
	...
	public String sEquiper()
	{
		if(this.localisationJoueur.getTresor().getTypeTresor() == TypeTresor.ARME)
		{
			...
			return "Suite a cette victoire, le courageux " + this.getNom() + " a trouve l'arme " + this.getArme().getNom() + " et va s'en equiper\n";
		}

		this.setArmure((Armure) this.localisationJoueur.getTresor());
		return "Suite a cette victoire, le courageux " + this.getNom() + " a trouve l'armure " + this.getArmure().getNom() + " et va s'en equiper\n";
	}

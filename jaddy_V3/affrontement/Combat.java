...
public class Combat {
	...
	public void lancerCombat()
	{
		...
		if(joueur.getNbVie() <=0)
		{
			...
			//System.out.println(monstre.regagnerVie(Joueur.nbVieJoueur += 1)); //le monstre va regagner ses pts de vie et un pt supplementaire
		...
		if(monstre.getNbVie() <=0)
		{
			...
			//System.out.println(joueur.regagnerVie(Joueur.nbVieJoueur += 1));  //le joueur va regagner ses pts de vie et un pt supplementaire
